" Vim color file
" Created from the TronLegacy theme
...
hi MatchParen ctermfg=NONE ctermbg=59 cterm=NONE guifg=NONE guibg=#525a61 gui=NONE
...
hi Pmenu ctermfg=NONE ctermbg=17 cterm=NONE guifg=NONE guibg=#232a32 gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=23 cterm=NONE guifg=NONE guibg=#183c66 gui=NONE
hi IncSearch ctermfg=NONE ctermbg=23 cterm=NONE guifg=NONE guibg=#183c66 gui=NONE
...
hi Folded ctermfg=59 ctermbg=17 cterm=NONE guifg=#324357 guibg=#232a32 gui=NONE
...
hi ErrorMsg ctermfg=15 ctermbg=12 cterm=NONE guifg=#ffffff guibg=#ff0000 gui=NONE
...
hi Type ctermfg=31 ctermbg=NONE cterm=NONE guifg=#267fb5 guibg=NONE gui=NONE
...
hi texSectionMarker ctermfg=103 ctermbg=17 cterm=NONE guifg=#748aa6 guibg=#232a32 gui=NONE
hi texSectionName ctermfg=214 ctermbg=17 cterm=NONE guifg=#ffb20d guibg=#232a32 gui=underline
